...
public extension UIViewController {
    ...
    internal final func getKeyboardHeight(fromNotification notification: Notification) -> CGFloat {
    ...
    internal final func getKeyboardTransitionDuration(fromNotification notification: Notification) -> TimeInterval {
